...
if(isset($_REQUEST['save-book-btn']))
{
    ...
    $update_book = mysqli_query($conn,"update tbl_book set book_name='$book_name', category='$category_name', isbnno='$isbn', author='$author_name', publisher='$publisher_name', price='$price', quantity='$quantity', availability='$availability' where id='$id'");
